...
const Invoice = () => {
   return (
      <Fragment>
         <PageTitle headingPara="Your business dashboard template" motherMenu="Layout" activeMenu="Blank" />

         <div className="row">
            <div className="col-lg-12">
               <div className="card mt-3">
					<div className="card-header">
						 Invoice <strong>01/01/01/2018</strong>{" "}<span className="float-right">
                           ...
                           <div className="row align-items-center" style={{fontSize: "0.9rem"}}>
                              <div className="col-auto">
                                 ...
                                 <img
                                    ...
                                    className="img-fluid mb-3 "   alt="" style={{maxHeight:"30px"}}  />
                                 <br />
                                 <span>
                              ...
                              <div className="col-auto">
                                 ...
                                 <img
                                    ...
                                    className="img-fluid width110"  alt="" style={{maxWidth: "114px"}} />
                              </div>
                           </div>
                        </div>
                     </div>
