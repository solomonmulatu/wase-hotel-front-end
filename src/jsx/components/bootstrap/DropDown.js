...
const UiDropDown = () => {
   return (
      <Fragment>
         <PageTitle headingPara="Label" activeMenu="Dropdown" motherMenu="Bootstrap" />
         <Row>
            <Col xl={4} lg={12}>
               <Card>
                  ...
                  <Card.Body>
                     <div className="basic-dropdown">
                        <Dropdown>
                           ...
                           <Dropdown.Menu>
                              <Dropdown.Item to={"#"}>Link 1</Dropdown.Item>
                              <Dropdown.Item to={"#"}>Link 2</Dropdown.Item>
                              <Dropdown.Item to={"#"}>Link 3</Dropdown.Item>
                           </Dropdown.Menu>
                        </Dropdown>
                     </div>
                  </Card.Body>
            ...
            <Col xl={4} lg={12}>
               <Card>
                  <Card.Header className="d-block">
                     ...
                     <Card.Text className="m-0 subtitle">
                        The
                        <code>.dropdown-divider</code> class is used to separate
                        links inside the dropdown menu with a thin horizontal
                        border
                     </Card.Text>
                  </Card.Header>
                  <Card.Body>
            ...
            <Col xl={4} lg={12}>
               <Card>
                  <Card.Header className="d-block">
                     ...
                     <Card.Text className="m-0 subtitle">
                        The
                        <code>.dropdown-header</code> class is used to add
                  ...
                  <Card.Body>
                     <div className="basic-dropdown">
                        <Dropdown>
                           ...
                           <Dropdown.Menu>
                              <Dropdown.Item to={"#"}>Normal</Dropdown.Item>
               ...
               <Card>
                  <Card.Header className="d-block">
                     ...
                     <Card.Text className="m-0 subtitle">
                        ...
                        <code>.dropdown-menu-right</code> class to the element
                        with .dropdown-menu
                     </Card.Text>
                  </Card.Header>
                  <Card.Body>
            ...
            <Col xl={4} lg={12}>
               <Card>
                  <Card.Header className="d-block">
                     ...
                     <Card.Text className="m-0 subtitle">
                        The
                        <code>.dropup</code> class makes the dropdown menu
               ...
               <Card>
                  ...
                  <Card.Body>
                     <div className="basic-dropdown">
                        ...
                        <div className="btn-group dropright mb-1">
                           <DropdownButton
                              as={ButtonGroup}
               ...
               <Card>
                  ...
                  <Card.Body>
                     <Row>
                        <Col xl={3}>
                           <Dropdown >
                              <Dropdown.Toggle  className="mb-1" variant="">
                                 Last 7 days
                              </Dropdown.Toggle>
                              <Dropdown.Menu>
                                 <Dropdown.Item to={"#"}>
                        ...
                        <Col xl={3}>
                           <Dropdown>
                              <Dropdown.Toggle variant="primary" size="sm" className="mb-1" >
                                 Last 1 Hour
                              </Dropdown.Toggle>
                              <Dropdown.Menu>
                                 <Dropdown.Item to={"#"}>
                        ...
                        <Col xl={3}>
                           <Dropdown>
                              ...
                              <Dropdown.Menu>
                                 <Dropdown.Item to={"#"}>6 AM</Dropdown.Item>
                                 <Dropdown.Item to={"#"}>9 AM</Dropdown.Item>
                                 <Dropdown.Item to={"#"}>12 AM</Dropdown.Item>
                              </Dropdown.Menu>
                           </Dropdown>
                        </Col>
                        ...
                        <Col xl={3}>
                           <Dropdown>
                              <Dropdown.Toggle
								 ...
								 className="mb-1" 
                              >
                                 <i className="ti-calendar m-r-5" /> March 20,
                        ...
                        <Col xl={3}>
                           <Dropdown>
                              <Dropdown.Toggle
                                 as="button"
                                 variant=""
                                 className="btn sharp btn-primary tp-btn mb-1"
                                 id="tp-btn"
                              >
                                 <svg
