...
const Widget = () => {
   return (
      <Fragment>
         <PageTitle headingPara="Statistics" activeMenu="Statistics" motherMenu="Widget" />
         <div className="row">
               ...
               <div className="row">
                  ...
                  <div className="col-xl-3 col-lg-6 col-sm-6">
                     <div className="widget-stat card bg-danger overflow-hidden">
                        ...
                        <div className="card-body p-0">
                           <LineChart3 color="#F77F8B" height="150" />
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div className="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
               <div className="card">
                  <div className="card-body text-center ai-icon  text-primary">
                     ...
                     <Link href="#;" className="btn my-2 btn-primary btn-lg px-4">
            ...
            <div className="col-xl-6 col-lg-6">
               <div className="card">
                  ...
                  <div className="chart-wrapper mt-3">
                     <BarChartNoPadding color="#F24887" />
                  </div>
               </div>
            </div>
            <div className="col-xl-6 col-lg-6">
               ...
               <div className="row">
                  ...
                  <div className="col-sm-6">
                     <div className="card">
                        ...
                        <div className="chart-wrapper">
                           <LineChart6 height="200" color="#ffb800" />
                        </div>
                     </div>
                  </div>
                  <div className="col-sm-6">
                     <div className="card">
                        ...
                        <div className="chart-wrapper">
                           <LineChart6 height="200" color="#dd2f6e" />
                        </div>
                     </div>
                  </div>
               </div>
